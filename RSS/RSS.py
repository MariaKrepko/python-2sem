...
def see_all():
	...
	button7 = Button(right, text = 'Скопировать', command = copy_link, bg = 'lightcyan', font = ('Arial', 16), fg = 'midnightblue')
...
def find_in():
	...
	button8 = Button(right, text = 'Скопировать', command = copy_link, bg = 'lightcyan', font = ('Arial', 16), fg = 'midnightblue')
	label2.pack()
	entry1.pack()
	button6.pack()
	label3.pack()
...
def add_feed():
	...
	bottom = Frame(right)
	bottom.pack()
	button4 = Button(bottom, text = 'Удалить выбранные', command = delete, bg = 'lightcyan', font = ('Arial', 16), fg = 'midnightblue')
	label5 = Label(right, text = 'Добавить источник: ', bg = 'paleturquoise', fg = 'midnightblue', font = ('Arial', 16), height = 2)
	...
	button9 = Button(bottom, text = 'Скопировать', command = copy_link, bg = 'lightcyan', font = ('Arial', 16), fg = 'midnightblue')
...
label1 = Label(window, text = 'Breaking news:', font = ('Arial', 16), bg = 'paleturquoise', fg = 'black', anchor = 'w', relief = RAISED)
...
button3 = Button(window, text = 'Управление\nисточниками', command = add_feed, bg = 'lightcyan', font = ('Arial', 16), fg = 'gray')
